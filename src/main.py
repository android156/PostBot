...
def setup_logging(config: IConfig) -> None:
    ...
    try:
        ...
        # Создаем RotatingFileHandler для ротации логов
        from logging.handlers import RotatingFileHandler
        rotating_handler = RotatingFileHandler(
            log_settings['file_path'],
            maxBytes=log_settings['max_file_size'],
            backupCount=log_settings['backup_count'],
            encoding='utf-8'
        )
        rotating_handler.setFormatter(logging.Formatter(log_settings['format']))
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                rotating_handler  # Вывод в файл с ротацией
            ]
        )
